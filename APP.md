...
<step_control>
  ...
  <StepExecution>
    ...
    3. Print the audit report as step output.
    4. Print full, unchanged session_payload.
  </StepExecution>
</step_control>
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload for the current document and the audit result.
    2. Write the audit result as an addendum to the current document.
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload using the active domain model as criteria.
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload for orphaned topics, orphaned decisions, unmade decisions, and stable decisions.
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload for lineages only.
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload for the distinctions artifact vs commentary and concept vs implementation.
    ...
    6. Print full, modified session_payload.
  </StepExecution>
</step_transformer>
...
<step_transformer>
  ...
  <StepExecution>
    This step does:
    1. Analyze session_payload for the base document, addendum, reclassification, orphan or decision pass, lineage pass, and distinction pass.
    2. Merge them into one clean consolidated document.
    3. Preserve distinctions.
    4. Remove duplication.
    5. Keep unresolved items unresolved.
    6. Avoid flattening ambiguity.
    7. Print full, modified session_payload.
  </StepExecution>
</step_transformer>
...
<step_control>
  ...
  <StepExecution>
    This step does:
    1. Analyze the consolidated document for internal consistency.
    ...
    3. Print the final consistency audit report as step output.
    4. Print full, unchanged session_payload.
  </StepExecution>
</step_control>
